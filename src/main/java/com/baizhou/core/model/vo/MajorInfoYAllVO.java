...
//    }
    ...
    public static MajorInfoYAllVO ConvertFromDTO(com.msg.MajorInfoYear proto, String year) {
        MajorInfoYAllVO info = new MajorInfoYAllVO();
