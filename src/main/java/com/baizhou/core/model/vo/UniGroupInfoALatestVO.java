...
@Getter
@Setter
public class UniGroupInfoALatestVO {
    /**
     * id
     */
    private Long id;
...
* */
    ...
    * */
    ...
    //    public com.msg.UniGroupInfoALatest ConvertToDTO(){
//    com.msg.UniGroupInfoALatest.Builder info = com.msg.UniGroupInfoALatest.newBuilder();
...
//    return info.build();
//   }
public  UniGroupInfoALatestVO  ConvertToDTO(){
    return  this;
}

    public static UniGroupInfoALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniGroupInfoALatestVO info = new UniGroupInfoALatestVO();
