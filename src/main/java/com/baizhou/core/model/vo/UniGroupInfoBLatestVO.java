...
@Getter
@Setter
public class UniGroupInfoBLatestVO {
    /**
     * id
     */
    private Long id;
...
//    public com.msg.UniGroupInfoBLatest ConvertToDTO(){
//    com.msg.UniGroupInfoBLatest.Builder info = com.msg.UniGroupInfoBLatest.newBuilder();
...
//   }
    ...
    public  UniGroupInfoBLatestVO  ConvertToDTO(){
        return  this;
    }

    public static UniGroupInfoBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniGroupInfoBLatestVO info = new UniGroupInfoBLatestVO();
