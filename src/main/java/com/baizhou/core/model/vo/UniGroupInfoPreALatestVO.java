...
@Getter
@Setter
public class UniGroupInfoPreALatestVO {
    /**
     * id
     */
    private Long id;
...
//    public com.msg.UniGroupInfoPreALatest ConvertToDTO(){
//    com.msg.UniGroupInfoPreALatest.Builder info = com.msg.UniGroupInfoPreALatest.newBuilder();
...
//    return info.build();
//   }
    public  UniGroupInfoPreALatestVO  ConvertToDTO(){
        return  this;
    }

    public static UniGroupInfoPreALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniGroupInfoPreALatestVO info = new UniGroupInfoPreALatestVO();
