...
@Getter
@Setter
public class UniGroupInfoPreBLatestVO {
    /**
     * id
     */
    private Long id;
...
//    public com.msg.UniGroupInfoPreBLatest ConvertToDTO(){
//    com.msg.UniGroupInfoPreBLatest.Builder info = com.msg.UniGroupInfoPreBLatest.newBuilder();
...
//   }
    ...
    public  UniGroupInfoPreBLatestVO  ConvertToDTO(){
        return  this;
    }

    public static UniGroupInfoPreBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniGroupInfoPreBLatestVO info = new UniGroupInfoPreBLatestVO();
