...
@Getter
@Setter
public class UniGroupInfoZXALatestVO {
    /**
     * id
     */
    private Long id;
...
//    public com.msg.UniGroupInfoZXALatest ConvertToDTO(){
//    com.msg.UniGroupInfoZXALatest.Builder info = com.msg.UniGroupInfoZXALatest.newBuilder();
...
//   }
    ...
    public  UniGroupInfoZXALatestVO  ConvertToDTO(){
        return  this;
    }

    public static UniGroupInfoZXALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniGroupInfoZXALatestVO info = new UniGroupInfoZXALatestVO();
