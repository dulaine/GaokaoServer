...
@Getter
@Setter
public class UniMajorInfoALatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoALatestVO info = new UniMajorInfoALatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoALatestVO info) {
//        UniMajorInfoALatestVO info = new UniMajorInfoALatestVO();
//        info.setId(proto.getId());
