...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoAVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoAVO info = new UniMajorInfoAVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoAVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoAVO info) {
//        UniMajorInfoAVO info = new UniMajorInfoAVO();
//        info.setId(proto.getId());
