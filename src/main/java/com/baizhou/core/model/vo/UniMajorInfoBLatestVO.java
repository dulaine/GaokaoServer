...
@Getter
@Setter
public class UniMajorInfoBLatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoBLatestVO info = new UniMajorInfoBLatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoBLatestVO info) {
//        UniMajorInfoBLatestVO info = new UniMajorInfoBLatestVO();
//        info.setId(proto.getId());
