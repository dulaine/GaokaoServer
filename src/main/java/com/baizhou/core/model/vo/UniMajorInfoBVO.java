...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoBVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoBVO info = new UniMajorInfoBVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoBVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoBVO info) {
//        UniMajorInfoBVO info = new UniMajorInfoBVO();
//        info.setId(proto.getId());
