...
@Getter
@Setter
public class UniMajorInfoPreALatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoPreALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoPreALatestVO info = new UniMajorInfoPreALatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoPreALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoPreALatestVO info) {
//        UniMajorInfoPreALatestVO info = new UniMajorInfoPreALatestVO();
//        info.setId(proto.getId());
