...
@Getter
@Setter
public class UniMajorInfoPreAVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoPreAVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoPreAVO info = new UniMajorInfoPreAVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoPreAVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoPreAVO info) {
//        UniMajorInfoPreAVO info = new UniMajorInfoPreAVO();
//        info.setId(proto.getId());
