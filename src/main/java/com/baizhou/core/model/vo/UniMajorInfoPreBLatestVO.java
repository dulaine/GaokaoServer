...
@Getter
@Setter
public class UniMajorInfoPreBLatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoPreBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoPreBLatestVO info = new UniMajorInfoPreBLatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoPreBLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoPreBLatestVO info) {
//        UniMajorInfoPreBLatestVO info = new UniMajorInfoPreBLatestVO();
//        info.setId(proto.getId());
