...
@Getter
@Setter
public class UniMajorInfoPreBVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoPreBVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoPreBVO info = new UniMajorInfoPreBVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoPreBVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoPreBVO info) {
//        UniMajorInfoPreBVO info = new UniMajorInfoPreBVO();
//        info.setId(proto.getId());
