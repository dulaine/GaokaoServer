...
@Getter
@Setter
public class UniMajorInfoZXALatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoZXALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoZXALatestVO info = new UniMajorInfoZXALatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoZXALatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoZXALatestVO info) {
//        UniMajorInfoZXALatestVO info = new UniMajorInfoZXALatestVO();
//        info.setId(proto.getId());
