...
@Getter
@Setter
public class UniMajorInfoZXAVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoZXAVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoZXAVO info = new UniMajorInfoZXAVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoZXAVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoZXAVO info) {
//        UniMajorInfoZXAVO info = new UniMajorInfoZXAVO();
//        info.setId(proto.getId());
