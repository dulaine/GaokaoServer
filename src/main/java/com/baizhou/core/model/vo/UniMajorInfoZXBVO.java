...
@Getter
@Setter
public class UniMajorInfoZXBVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoZXBVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoZXBVO info = new UniMajorInfoZXBVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoZXBVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoZXBVO info) {
//        UniMajorInfoZXBVO info = new UniMajorInfoZXBVO();
//        info.setId(proto.getId());
