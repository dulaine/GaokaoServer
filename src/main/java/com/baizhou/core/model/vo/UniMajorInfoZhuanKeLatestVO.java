...
@Getter
@Setter
public class UniMajorInfoZhuanKeLatestVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoZhuanKeLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoZhuanKeLatestVO info = new UniMajorInfoZhuanKeLatestVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoZhuanKeLatestVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoZhuanKeLatestVO info) {
//        UniMajorInfoZhuanKeLatestVO info = new UniMajorInfoZhuanKeLatestVO();
//        info.setId(proto.getId());
