...
@Getter
@Setter
public class UniMajorInfoZhuanKeVO {
    /**
     * id
     */
    private Long id;
...
//        info.addAllMajorNameDetails(new ArrayList<>());
    ...
    public static UniMajorInfoZhuanKeVO ConvertFromDTO(com.msg.UniMajorInfo proto) {
        UniMajorInfoZhuanKeVO info = new UniMajorInfoZhuanKeVO();
        info.setId(proto.getId());

        return ConvertFromDTO(proto, info);
    }

    public static UniMajorInfoZhuanKeVO ConvertFromDTO(com.msg.UniMajorInfo proto,  UniMajorInfoZhuanKeVO info) {
//        UniMajorInfoZhuanKeVO info = new UniMajorInfoZhuanKeVO();
//        info.setId(proto.getId());
