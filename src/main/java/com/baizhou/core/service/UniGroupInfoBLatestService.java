...
public interface UniGroupInfoBLatestService {
    /**
     * 保存UniGroupInfoBLatest
     * @param uniGroupInfoBLatest
     * @return
     */
    UniGroupInfoBLatest saveUniGroupInfoBLatest(UniGroupInfoBLatestVO uniGroupInfoBLatest);
    ...
    * 更新
    * */
    String updateUniGroupInfoBLatest(UniGroupInfoBLatestVO uniGroupInfoBLatestVO);
     ...
     * @return
     */
    UniGroupInfoBLatestVO findOneById(Long id);

    /**
    * 返回所有
    * */
   List<UniGroupInfoBLatestVO> getAllUniGroupInfoBLatests();
    /**
     *  根据UniMajorCode查询
     * @param uniMajorCode
     * @return
