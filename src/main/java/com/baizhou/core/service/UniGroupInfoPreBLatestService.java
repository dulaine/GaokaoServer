...
public interface UniGroupInfoPreBLatestService {
    /**
     * 保存UniGroupInfoPreBLatest
     * @param uniGroupInfoPreBLatest
     * @return
     */
    UniGroupInfoPreBLatest saveUniGroupInfoPreBLatest(UniGroupInfoPreBLatestVO uniGroupInfoPreBLatest);
    ...
    * 更新
    * */
    String updateUniGroupInfoPreBLatest(UniGroupInfoPreBLatestVO uniGroupInfoPreBLatestVO);
     ...
     * @return
     */
    UniGroupInfoPreBLatestVO findOneById(Long id);

    /**
    * 返回所有
    * */
   List<UniGroupInfoPreBLatestVO> getAllUniGroupInfoPreBLatests();
    /**
     *  根据UniMajorCode查询
     * @param uniMajorCode
     * @return
