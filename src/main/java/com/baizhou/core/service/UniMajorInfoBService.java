...
public interface UniMajorInfoBService {
    /**
     * 保存UniMajorInfoB
     * @param uniMajorInfoA
     * @return
     */
    UniMajorInfoB saveUniMajorInfoB(UniMajorInfoBVO uniMajorInfoA);
    ...
    * 更新
    * */
    String updateUniMajorInfoB(UniMajorInfoBVO uniMajorInfoAVO);
     ...
     * @return
     */
    UniMajorInfoBVO findOneById(Long id);

    List<UniMajorInfoBVO> findByIdIn(List<Long> id);
    /**
    * 返回所有
    * */
   List<UniMajorInfoBVO> getAllUniMajorInfoBs();
    /**
     *  根据UniMajorCode查询
     * @param uniMajorCode
     * @return
    ...
    List<UniMajorInfoBVO> findByUniMajorCodeIn(List<String> ids);

    void deleteByExamYear(String examYear);

    List<UniMajorInfoBVO> findByUniMajorCodeAndExamYear(String uniMajorCode, String examYear);
    List<UniMajorInfoBVO> findByUniMajorCodeAndMajorCodeAndExamYear(String uniMajorCode, String majorCode, String examYear);
    ...
    // 批量存储的方法
    List<UniMajorInfoB> batchSave(List<UniMajorInfoB> list);

    // 批量更新的方法
    List<UniMajorInfoB> batchUpdate(List<UniMajorInfoB> list);

    List<String> selectDistinctYear();

    List<UniMajorInfoBVO> findByPiciAndExamYear(Integer pici, String examYear);
