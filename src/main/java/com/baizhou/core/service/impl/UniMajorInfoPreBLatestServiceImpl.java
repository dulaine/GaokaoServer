...
@Service
public class UniMajorInfoPreBLatestServiceImpl implements UniMajorInfoPreBLatestService {


    @Autowired
    private UniMajorInfoPreBLatestRepo imp;
     ...
     */
    @Override
    public UniMajorInfoPreBLatest saveUniMajorInfoPreBLatest(UniMajorInfoPreBLatestVO uniMajorInfoALatest) {

        return imp.save(BeanMapper.map(uniMajorInfoALatest, UniMajorInfoPreBLatest.class));
    }
    ...
    public boolean deleteByKeyId(Long id) {
        UniMajorInfoPreBLatest entity = imp.findById(id).orElse(null);
     ...
     */
    @Override
    public UniMajorInfoPreBLatestVO findOneById(Long id) {
        UniMajorInfoPreBLatest entity = imp.findById(id).orElse(null);
        if (entity == null) return null;
        return BeanMapper.map(entity, UniMajorInfoPreBLatestVO.class);
    }

    @Override
    public List<UniMajorInfoPreBLatestVO> findByIdIn(List<Long> id) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByIdIn(id);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
        }
        return voList;
    }
     ...
     */
    @Override
    public List<UniMajorInfoPreBLatestVO> getAllUniMajorInfoPreBLatests() {
        return BeanMapper.mapList(imp.findAll(), UniMajorInfoPreBLatestVO.class);
    }
     ...
     */
    @Override
    public String updateUniMajorInfoPreBLatest(UniMajorInfoPreBLatestVO uniMajorInfoALatestVO) {
        UniMajorInfoPreBLatest uniMajorInfoALatest = BeanMapper.map(uniMajorInfoALatestVO, UniMajorInfoPreBLatest.class);
    ...
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCode(String uniMajorCode) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCode(uniMajorCode);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCodeLike(String uniMajorCode) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCodeLike("%" + uniMajorCode + "%");
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByPici(Integer pici) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByPici(pici);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolName(String schoolName) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolName(schoolName);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolNameLike(String schoolName) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolNameLike("%" + schoolName + "%");
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolLvl1(Integer schoolLvl1) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolLvl1(schoolLvl1);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolLvl2(Integer schoolLvl2) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolLvl2(schoolLvl2);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolLvl3(Integer schoolLvl3) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolLvl3(schoolLvl3);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolType(String schoolType) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolType(schoolType);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findBySchoolTypeLike(String schoolType) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findBySchoolTypeLike("%" + schoolType + "%");
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByProvince(String province) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByProvince(province);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByProvinceLike(String province) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByProvinceLike("%" + province + "%");
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByMajorName(String majorName) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByMajorName(majorName);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByMajorNameLike(String majorName) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByMajorNameLike("%" + majorName + "%");
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByIsZhongWai(Integer isZhongWai){
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByIsZhongWai(isZhongWai);
        if(  inList != null){
            for (UniMajorInfoPreBLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoPreBLatestVO.class));
            }
    ...
    public List<UniMajorInfoPreBLatestVO> findByIsBenSuo(Integer isBenSuo){
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByIsBenSuo(isBenSuo);
        if(  inList != null){
            for (UniMajorInfoPreBLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoPreBLatestVO.class));
            }
...
//    public Map<String, Object> listbyPage(String uniMajorCode,Integer pici,String schoolName,Integer schoolLvl1,Integer schoolLvl2,Integer schoolLvl3,String schoolType,String province,String majorName,Pageable pageable) {
        ...
        org.springframework.data.domain.Page<UniMajorInfoPreBLatest> pageResult = null;
...
//            boolean finalIsMajor2Code = isMajor2Code;
            ...
            Specification<UniMajorInfoPreBLatest> spec = (Specification<UniMajorInfoPreBLatest>) (root, query, cb) -> {
...
//            pageResult = imp.findPage(spec, pageable);
        ...
        List<UniMajorInfoPreBLatestVO> list = BeanMapper.mapList(pageResult.getContent(), UniMajorInfoPreBLatestVO.class);
...
//        }
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCodeIn(List<String> ids) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCodeIn(ids);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCodeAndExamYear(String uniMajorCode, String examYear) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCodeAndExamYear(uniMajorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByHistMajorIdsAndExamYear(List<Long> histDBIds, String examYear)
    {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByHistMajorIdsAndExamYear( histDBIds, examYear);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCodeAndMajorCodeAndExamYear(String uniMajorCode, String majorCode, String examYear) {
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCodeAndMajorCodeAndExamYear(uniMajorCode, majorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByUniMajorCodeInAndExamYear(List<String> uniMajorCodes, String examYear){
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByUniMajorCodeInAndExamYear(uniMajorCodes, examYear);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
    ...
    @Override
    @Transactional
    public List<UniMajorInfoPreBLatest> batchSave(List<UniMajorInfoPreBLatest> list){
        for (int i = 0; i < list.size(); i++) {
    ...
    @Override
    @Transactional
    public List<UniMajorInfoPreBLatest> batchUpdate(List<UniMajorInfoPreBLatest> list){
        for (int i = 0; i < list.size(); i++) {
            if(i>0 && i % ConstDefine.BATCH_SIZE == 0){
                entityManager.flush(); // flush 触发事务 同步
                entityManager.clear(); // 清除缓存;  清除实体
...
//        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
    ...
    @Override
    public List<UniMajorInfoPreBLatestVO> findByPiciAndExamYear(Integer pici, String examYear){
        List<UniMajorInfoPreBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoPreBLatest> inList = imp.findByPiciAndExamYear(pici, examYear);
        if (inList != null) {
            for (UniMajorInfoPreBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoPreBLatestVO.class));
            }
