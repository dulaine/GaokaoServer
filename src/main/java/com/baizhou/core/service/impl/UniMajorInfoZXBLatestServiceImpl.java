...
@Service
public class UniMajorInfoZXBLatestServiceImpl implements UniMajorInfoZXBLatestService {


    @Autowired
    private UniMajorInfoZXBLatestRepo imp;
     ...
     */
    @Override
    public UniMajorInfoZXBLatest saveUniMajorInfoZXBLatest(UniMajorInfoZXBLatestVO uniMajorInfoALatest) {

        return imp.save(BeanMapper.map(uniMajorInfoALatest, UniMajorInfoZXBLatest.class));
    }
    ...
    public boolean deleteByKeyId(Long id) {
        UniMajorInfoZXBLatest entity = imp.findById(id).orElse(null);
     ...
     */
    @Override
    public UniMajorInfoZXBLatestVO findOneById(Long id) {
        UniMajorInfoZXBLatest entity = imp.findById(id).orElse(null);
        if (entity == null) return null;
        return BeanMapper.map(entity, UniMajorInfoZXBLatestVO.class);
    }

    @Override
    public List<UniMajorInfoZXBLatestVO> findByIdIn(List<Long> id) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByIdIn(id);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
        }
        return voList;
    }
     ...
     */
    @Override
    public List<UniMajorInfoZXBLatestVO> getAllUniMajorInfoZXBLatests() {
        return BeanMapper.mapList(imp.findAll(), UniMajorInfoZXBLatestVO.class);
    }
     ...
     */
    @Override
    public String updateUniMajorInfoZXBLatest(UniMajorInfoZXBLatestVO uniMajorInfoALatestVO) {
        UniMajorInfoZXBLatest uniMajorInfoALatest = BeanMapper.map(uniMajorInfoALatestVO, UniMajorInfoZXBLatest.class);
    ...
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCode(String uniMajorCode) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCode(uniMajorCode);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCodeLike(String uniMajorCode) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCodeLike("%" + uniMajorCode + "%");
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByPici(Integer pici) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByPici(pici);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolName(String schoolName) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolName(schoolName);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolNameLike(String schoolName) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolNameLike("%" + schoolName + "%");
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolLvl1(Integer schoolLvl1) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolLvl1(schoolLvl1);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolLvl2(Integer schoolLvl2) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolLvl2(schoolLvl2);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolLvl3(Integer schoolLvl3) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolLvl3(schoolLvl3);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolType(String schoolType) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolType(schoolType);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findBySchoolTypeLike(String schoolType) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findBySchoolTypeLike("%" + schoolType + "%");
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByProvince(String province) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByProvince(province);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByProvinceLike(String province) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByProvinceLike("%" + province + "%");
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByMajorName(String majorName) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByMajorName(majorName);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByMajorNameLike(String majorName) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByMajorNameLike("%" + majorName + "%");
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByIsZhongWai(Integer isZhongWai){
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByIsZhongWai(isZhongWai);
        if(  inList != null){
            for (UniMajorInfoZXBLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZXBLatestVO.class));
            }
    ...
    public List<UniMajorInfoZXBLatestVO> findByIsBenSuo(Integer isBenSuo){
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByIsBenSuo(isBenSuo);
        if(  inList != null){
            for (UniMajorInfoZXBLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZXBLatestVO.class));
            }
...
//    public Map<String, Object> listbyPage(String uniMajorCode,Integer pici,String schoolName,Integer schoolLvl1,Integer schoolLvl2,Integer schoolLvl3,String schoolType,String province,String majorName,Pageable pageable) {
        ...
        org.springframework.data.domain.Page<UniMajorInfoZXBLatest> pageResult = null;
...
//            boolean finalIsMajor2Code = isMajor2Code;
            ...
            Specification<UniMajorInfoZXBLatest> spec = (Specification<UniMajorInfoZXBLatest>) (root, query, cb) -> {
...
//            pageResult = imp.findPage(spec, pageable);
        ...
        List<UniMajorInfoZXBLatestVO> list = BeanMapper.mapList(pageResult.getContent(), UniMajorInfoZXBLatestVO.class);
...
//        }
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCodeIn(List<String> ids) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCodeIn(ids);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCodeAndExamYear(String uniMajorCode, String examYear) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCodeAndExamYear(uniMajorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByHistMajorIdsAndExamYear(List<Long> histDBIds, String examYear)
    {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByHistMajorIdsAndExamYear( histDBIds, examYear);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCodeAndMajorCodeAndExamYear(String uniMajorCode, String majorCode, String examYear) {
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCodeAndMajorCodeAndExamYear(uniMajorCode, majorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByUniMajorCodeInAndExamYear(List<String> uniMajorCodes, String examYear){
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByUniMajorCodeInAndExamYear(uniMajorCodes, examYear);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZXBLatest> batchSave(List<UniMajorInfoZXBLatest> list){
        for (int i = 0; i < list.size(); i++) {
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZXBLatest> batchUpdate(List<UniMajorInfoZXBLatest> list){
        for (int i = 0; i < list.size(); i++) {
            if(i>0 && i % ConstDefine.BATCH_SIZE == 0){
                entityManager.flush(); // flush 触发事务 同步
                entityManager.clear(); // 清除缓存;  清除实体
...
//        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
    ...
    @Override
    public List<UniMajorInfoZXBLatestVO> findByPiciAndExamYear(Integer pici, String examYear){
        List<UniMajorInfoZXBLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZXBLatest> inList = imp.findByPiciAndExamYear(pici, examYear);
        if (inList != null) {
            for (UniMajorInfoZXBLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZXBLatestVO.class));
            }
