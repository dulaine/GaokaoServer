...
@Service
public class UniMajorInfoZhuanKeLatestServiceImpl implements UniMajorInfoZhuanKeLatestService {


    @Autowired
    private UniMajorInfoZhuanKeLatestRepo imp;
     ...
     */
    @Override
    public UniMajorInfoZhuanKeLatest saveUniMajorInfoZhuanKeLatest(UniMajorInfoZhuanKeLatestVO uniMajorInfoALatest) {

        return imp.save(BeanMapper.map(uniMajorInfoALatest, UniMajorInfoZhuanKeLatest.class));
    }
    ...
    public boolean deleteByKeyId(Long id) {
        UniMajorInfoZhuanKeLatest entity = imp.findById(id).orElse(null);
     ...
     */
    @Override
    public UniMajorInfoZhuanKeLatestVO findOneById(Long id) {
        UniMajorInfoZhuanKeLatest entity = imp.findById(id).orElse(null);
        if (entity == null) return null;
        return BeanMapper.map(entity, UniMajorInfoZhuanKeLatestVO.class);
    }

    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByIdIn(List<Long> id) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByIdIn(id);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
        }
        return voList;
    }
     ...
     */
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> getAllUniMajorInfoZhuanKeLatests() {
        return BeanMapper.mapList(imp.findAll(), UniMajorInfoZhuanKeLatestVO.class);
    }
     ...
     */
    @Override
    public String updateUniMajorInfoZhuanKeLatest(UniMajorInfoZhuanKeLatestVO uniMajorInfoALatestVO) {
        UniMajorInfoZhuanKeLatest uniMajorInfoALatest = BeanMapper.map(uniMajorInfoALatestVO, UniMajorInfoZhuanKeLatest.class);
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCode(String uniMajorCode) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCode(uniMajorCode);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCodeLike(String uniMajorCode) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCodeLike("%" + uniMajorCode + "%");
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByPici(Integer pici) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByPici(pici);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolName(String schoolName) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolName(schoolName);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolNameLike(String schoolName) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolNameLike("%" + schoolName + "%");
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolLvl1(Integer schoolLvl1) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolLvl1(schoolLvl1);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolLvl2(Integer schoolLvl2) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolLvl2(schoolLvl2);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolLvl3(Integer schoolLvl3) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolLvl3(schoolLvl3);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolType(String schoolType) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolType(schoolType);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findBySchoolTypeLike(String schoolType) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findBySchoolTypeLike("%" + schoolType + "%");
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByProvince(String province) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByProvince(province);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByProvinceLike(String province) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByProvinceLike("%" + province + "%");
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByMajorName(String majorName) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByMajorName(majorName);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByMajorNameLike(String majorName) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByMajorNameLike("%" + majorName + "%");
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByIsZhongWai(Integer isZhongWai){
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByIsZhongWai(isZhongWai);
        if(  inList != null){
            for (UniMajorInfoZhuanKeLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeLatestVO> findByIsBenSuo(Integer isBenSuo){
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByIsBenSuo(isBenSuo);
        if(  inList != null){
            for (UniMajorInfoZhuanKeLatest inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeLatestVO.class));
            }
...
//    public Map<String, Object> listbyPage(String uniMajorCode,Integer pici,String schoolName,Integer schoolLvl1,Integer schoolLvl2,Integer schoolLvl3,String schoolType,String province,String majorName,Pageable pageable) {
        ...
        org.springframework.data.domain.Page<UniMajorInfoZhuanKeLatest> pageResult = null;
...
//            boolean finalIsMajor2Code = isMajor2Code;
            ...
            Specification<UniMajorInfoZhuanKeLatest> spec = (Specification<UniMajorInfoZhuanKeLatest>) (root, query, cb) -> {
...
//            pageResult = imp.findPage(spec, pageable);
        ...
        List<UniMajorInfoZhuanKeLatestVO> list = BeanMapper.mapList(pageResult.getContent(), UniMajorInfoZhuanKeLatestVO.class);
...
//        }
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCodeIn(List<String> ids) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCodeIn(ids);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCodeAndExamYear(String uniMajorCode, String examYear) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCodeAndExamYear(uniMajorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByHistMajorIdsAndExamYear(List<Long> histDBIds, String examYear)
    {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByHistMajorIdsAndExamYear( histDBIds, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCodeAndMajorCodeAndExamYear(String uniMajorCode, String majorCode, String examYear) {
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCodeAndMajorCodeAndExamYear(uniMajorCode, majorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByUniMajorCodeInAndExamYear(List<String> uniMajorCodes, String examYear){
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByUniMajorCodeInAndExamYear(uniMajorCodes, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZhuanKeLatest> batchSave(List<UniMajorInfoZhuanKeLatest> list){
        for (int i = 0; i < list.size(); i++) {
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZhuanKeLatest> batchUpdate(List<UniMajorInfoZhuanKeLatest> list){
        for (int i = 0; i < list.size(); i++) {
            if(i>0 && i % ConstDefine.BATCH_SIZE == 0){
                entityManager.flush(); // flush 触发事务 同步
                entityManager.clear(); // 清除缓存;  清除实体
...
//        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
    ...
    @Override
    public List<UniMajorInfoZhuanKeLatestVO> findByPiciAndExamYear(Integer pici, String examYear){
        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKeLatest> inList = imp.findByPiciAndExamYear(pici, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKeLatest inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeLatestVO.class));
            }
