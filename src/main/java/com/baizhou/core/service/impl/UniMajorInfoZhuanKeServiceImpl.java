...
@Transactional
@Service
public class UniMajorInfoZhuanKeServiceImpl  implements UniMajorInfoZhuanKeService {


    @Autowired
    private UniMajorInfoZhuanKeRepo imp;
     ...
     */
    @Override
    public UniMajorInfoZhuanKe saveUniMajorInfoZhuanKe(UniMajorInfoZhuanKeVO uniMajorInfoA) {

        return imp.save(BeanMapper.map(uniMajorInfoA, UniMajorInfoZhuanKe.class));
    }
    /**
     * 删除单条记录
     * @param id
    ...
    public boolean deleteByKeyId(Long id) {
        UniMajorInfoZhuanKe entity = imp.findById(id).orElse(null);
     ...
     */
    @Override
    public UniMajorInfoZhuanKeVO findOneById(Long id) {
        UniMajorInfoZhuanKe entity = imp.findById(id).orElse(null);
        if(entity == null) return null;
        return  BeanMapper.map(entity, UniMajorInfoZhuanKeVO.class);
    }
    @Override
    public List<UniMajorInfoZhuanKeVO> findByIdIn(List<Long> id) {
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByIdIn(id);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
        }
        return  voList;
    }    /**
     ...
     */
    @Override
    public List<UniMajorInfoZhuanKeVO> getAllUniMajorInfoZhuanKes() {
        return BeanMapper.mapList(imp.findAll(), UniMajorInfoZhuanKeVO.class);
    }
    /**
     * 更新记录
     ...
     */
    @Override
    public String updateUniMajorInfoZhuanKe(UniMajorInfoZhuanKeVO uniMajorInfoAVO) {
        UniMajorInfoZhuanKe uniMajorInfoA = BeanMapper.map(uniMajorInfoAVO, UniMajorInfoZhuanKe.class);
  ...
  public List<UniMajorInfoZhuanKeVO> findByUniMajorCode(String uniMajorCode){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByUniMajorCode(uniMajorCode);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByUniMajorCodeLike(String uniMajorCode){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByUniMajorCodeLike("%"+uniMajorCode+"%");
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByPici(Integer pici){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByPici(pici);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolName(String schoolName){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolName(schoolName);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolNameLike(String schoolName){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolNameLike("%"+schoolName+"%");
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolLvl1(Integer schoolLvl1){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolLvl1(schoolLvl1);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolLvl2(Integer schoolLvl2){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolLvl2(schoolLvl2);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolLvl3(Integer schoolLvl3){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolLvl3(schoolLvl3);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolType(String schoolType){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolType(schoolType);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findBySchoolTypeLike(String schoolType){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findBySchoolTypeLike("%"+schoolType+"%");
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByProvince(String province){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByProvince(province);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByProvinceLike(String province){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByProvinceLike("%"+province+"%");
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByMajorName(String majorName){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByMajorName(majorName);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
  ...
  public List<UniMajorInfoZhuanKeVO> findByMajorNameLike(String majorName){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByMajorNameLike("%"+majorName+"%");
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeVO> findByIsZhongWai(Integer isZhongWai){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByIsZhongWai(isZhongWai);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
    ...
    public List<UniMajorInfoZhuanKeVO> findByIsBenSuo(Integer isBenSuo){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByIsBenSuo(isBenSuo);
        if(  inList != null){
            for (UniMajorInfoZhuanKe inf:inList) {
                voList.add(BeanMapper.map(inf,UniMajorInfoZhuanKeVO.class));
            }
...
//    public Map<String, Object> listbyPage(String uniMajorCode,Integer pici,String schoolName,Integer schoolLvl1,Integer schoolLvl2,Integer schoolLvl3,String schoolType,String province,String majorName,Pageable pageable) {
        ...
        org.springframework.data.domain.Page<UniMajorInfoZhuanKe> pageResult = null;
...
//        if (StringUtils.isEmpty(uniMajorCode)  && StringUtils.isEmpty(pici)  && StringUtils.isEmpty(schoolName)  && StringUtils.isEmpty(schoolLvl1)  && StringUtils.isEmpty(schoolLvl2)  && StringUtils.isEmpty(schoolLvl3)  && StringUtils.isEmpty(schoolType)  && StringUtils.isEmpty(province)  && StringUtils.isEmpty(majorName) ) {
            ...
            Specification<UniMajorInfoZhuanKe> spec = (Specification<UniMajorInfoZhuanKe>) (root, query, cb) -> {
...
//                        }
        ...
        List<UniMajorInfoZhuanKeVO> list = BeanMapper.mapList(pageResult.getContent(), UniMajorInfoZhuanKeVO.class);
    ...
    @Override
    public List<UniMajorInfoZhuanKeVO> findByUniMajorCodeIn(List<String> ids)
    {
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByUniMajorCodeIn( ids);
        if (inList != null) {
            for (UniMajorInfoZhuanKe inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeVO> findByUniMajorCodeAndExamYear(String uniMajorCode, String examYear) {
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByUniMajorCodeAndExamYear(uniMajorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKe inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeVO.class));
            }
    ...
    @Override
    public List<UniMajorInfoZhuanKeVO> findByUniMajorCodeAndMajorCodeAndExamYear(String uniMajorCode, String majorCode, String examYear) {
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByUniMajorCodeAndMajorCodeAndExamYear(uniMajorCode, majorCode, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKe inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeVO.class));
            }
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZhuanKe> batchSave(List<UniMajorInfoZhuanKe> entityList){
//        List<UniMajorInfoZhuanKe> entityList = new ArrayList<>();
//        for (int i = 0; i < list.size(); i++) {
//            entityList.add(BeanMapper.map(list.get(i), UniMajorInfoZhuanKe.class));
//        }
...
//            entityManager.persist(BeanMapper.map(list.get(i), UniMajorInfoZhuanKe.class));
    ...
    @Override
    @Transactional
    public List<UniMajorInfoZhuanKe> batchUpdate(List<UniMajorInfoZhuanKe> list){
        for (int i = 0; i < list.size(); i++) {
            if(i>0 && i % ConstDefine.BATCH_SIZE == 0){
                entityManager.flush(); // flush 触发事务 同步
                entityManager.clear(); // 清除缓存;  清除实体
...
//        List<UniMajorInfoZhuanKeLatestVO> voList = new ArrayList<>();
    ...
    @Override
    public List<UniMajorInfoZhuanKeVO> findByPiciAndExamYear(Integer pici, String examYear){
        List<UniMajorInfoZhuanKeVO> voList = new ArrayList<>();
        List<UniMajorInfoZhuanKe> inList = imp.findByPiciAndExamYear(pici, examYear);
        if (inList != null) {
            for (UniMajorInfoZhuanKe inf : inList) {
                voList.add(BeanMapper.map(inf, UniMajorInfoZhuanKeVO.class));
            }
