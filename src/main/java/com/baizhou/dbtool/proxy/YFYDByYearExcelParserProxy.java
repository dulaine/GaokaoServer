...
public class YFYDByYearExcelParserProxy implements IExcelParseProxy {
    @Override
    public void DoProxy(ExcelTableData table, File file, Param Param) {
        ...
        System.out.println("开始解析一分一段" + year);

//        DBProxy.Getinstance().ScoreToRankInfoService.deleteAll();
        DBProxy.Getinstance().ScoreToRankInfoService.deleteByExamYear(year);
