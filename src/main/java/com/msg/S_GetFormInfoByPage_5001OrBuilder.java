...
public interface S_GetFormInfoByPage_5001OrBuilder extends
    // @@protoc_insertion_point(interface_extends:S_GetFormInfoByPage_5001)
   ...
   */
  java.util.List<com.msg.FormInfo> 
      getFormInfoList();
  /**
   * <code>repeated .FormInfo formInfo = 2;</code>
   */
  com.msg.FormInfo getFormInfo(int index);
  /**
   * <code>repeated .FormInfo formInfo = 2;</code>
   */
  int getFormInfoCount();
  /**
   * <code>repeated .FormInfo formInfo = 2;</code>
   */
  java.util.List<? extends com.msg.FormInfoOrBuilder> 
